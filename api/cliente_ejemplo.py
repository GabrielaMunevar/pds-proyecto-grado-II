...
Muestra cómo interactuar con la API desde Python
"""
...
def ejemplo_basico():
    """Ejemplo básico de generación de PLS"""
    print("="*80)
    print("EJEMPLO 1: Generación Básica de PLS")
    print("="*80)
...
def ejemplo_con_metricas():
    """Ejemplo con cálculo de métricas"""
    print("="*80)
    print("EJEMPLO 2: Generación + Métricas")
    print("="*80)
    ...
    print("🔄 Generating PLS with metrics...")
...
def ejemplo_batch():
    """Ejemplo procesando múltiples textos"""
    print("="*80)
